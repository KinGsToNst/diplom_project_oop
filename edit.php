                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="job_title" id="simpleinput" class="form-control" value="<?=$user_info["job_title"];?>">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Номер телефона</label>
                                    <input type="text"  name="phone" id="simpleinput" class="form-control" value="<?=$user_info["phone"];?>">
                                </div>

                                <!-- address -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Адрес</label>
                                    <input type="text" id="simpleinput" name="address" class="form-control" value="<?=$user_info["address"];?>">
                                </div>
